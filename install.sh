...
REPO="${DOCKERMGRREPO:-https://github.com/$SCRIPTS_PREFIX}/supabase"
APPVERSION="$(__appversion "$REPO/raw/$REPO_BRANCH/version.txt")"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Defaults variables
APPNAME="supabase"
export INSTDIR="$HOME/.local/share/CasjaysDev/$SCRIPTS_PREFIX/supabase"
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Set container hostname and domain - Default: [supabase.$SET_HOST_FULL_NAME] [$SET_HOST_FULL_DOMAIN]
CONTAINER_HOSTNAME=""
