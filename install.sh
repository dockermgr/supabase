...
# Defaults variables
APPNAME="supabase"
INSTDIR="$HOME/.local/share/dockermgr/supabase"
APPDIR="$HOME/.local/share/srv/docker/supabase"
DATADIR="$HOME/.local/share/srv/docker/supabase/files"
...
HUB_URL="casjaysdevdocker/supabase:latest"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
if [ -z "$HUB_URL" ] || [ "$HUB_URL" = "hello-world" ] || echo "$HUB_URL" | grep -q "supabase"; then
